...
const bool DEBUG = true; // set true to enable prints to serial port, but will slow down latency of response
...
void loop()
{
  bool but = digitalRead(BUTTON_PIN); // always pay attention to button
